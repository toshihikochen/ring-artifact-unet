...
CHECKPOINT_PATH = "lightning_logs/fpn_residual_denseunet_gradloss/version_0/checkpoints/epoch=199-step=12600.ckpt"
DEVICE = "cuda"
EPS = 1e-9

model = RingArtifactFPNResidualDenseUNet.load_from_checkpoint(CHECKPOINT_PATH)
model.to(DEVICE)
model.eval()
